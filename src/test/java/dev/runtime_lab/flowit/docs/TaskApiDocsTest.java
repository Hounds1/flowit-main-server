...
class TaskApiDocsTest {
	...
	private org.springframework.restdocs.payload.FieldDescriptor[] taskListResponseFields() {
		return new org.springframework.restdocs.payload.FieldDescriptor[] {
			...
			fieldWithPath("data.items[].status").type(JsonFieldType.STRING).description("작업 상태입니다. link:enum-reference.html#task-status[TaskStatus]를 참고합니다."),
	...
	private org.springframework.restdocs.payload.FieldDescriptor[] taskDetailResponseFields() {
		return new org.springframework.restdocs.payload.FieldDescriptor[] {
			...
			fieldWithPath("data.status").type(JsonFieldType.STRING).description("작업 상태입니다. link:enum-reference.html#task-status[TaskStatus]를 참고합니다."),
	...
	private org.springframework.restdocs.payload.FieldDescriptor[] taskHistoryListResponseFields() {
		return new org.springframework.restdocs.payload.FieldDescriptor[] {
			...
			fieldWithPath("data.items[].action").type(JsonFieldType.STRING).description("변경 액션입니다. link:enum-reference.html#task-history-action[TaskHistoryAction]을 참고합니다."),
			fieldWithPath("data.items[].changes").type(JsonFieldType.ARRAY).description("문장 조합 전 의미 단위 변경 목록입니다."),
			fieldWithPath("data.items[].changes[].element").type(JsonFieldType.STRING).description("변경 요소입니다. link:enum-reference.html#task-history-element[TaskHistoryElement]를 참고합니다."),
