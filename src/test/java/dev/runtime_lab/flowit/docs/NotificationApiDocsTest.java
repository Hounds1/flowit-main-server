		...
		mockMvc.perform(get("/v1/notifications")
			...
			.andDo(document("notifications-list",
				...
				responseFields(
					...
					fieldWithPath("data.items[].type").type(JsonFieldType.STRING).description("알림 유형입니다. link:enum-reference.html#notification-alert-type[NotificationAlertType]을 참고합니다."),
					...
					fieldWithPath("data.items[].scope.type").type(JsonFieldType.STRING).description("알림 범위 유형입니다. link:enum-reference.html#notification-scope-type[NotificationScopeType]을 참고합니다."),
					...
					fieldWithPath("data.items[].actor.type").type(JsonFieldType.STRING).description("알림 주체 유형입니다. link:enum-reference.html#notification-actor-type[NotificationActorType]을 참고합니다."),
					...
					fieldWithPath("data.items[].subject.type").type(JsonFieldType.STRING).description("알림 대상 유형입니다. link:enum-reference.html#notification-subject-type[NotificationSubjectType]을 참고합니다."),
					...
					fieldWithPath("data.items[].link.type").type(JsonFieldType.STRING).description("링크 유형입니다. link:enum-reference.html#notification-link-type[NotificationLinkType]을 참고합니다."),
